...
function App() {
	...
	const loadUser = async () => {
		try {
			...
			const startR = Math.floor(userInfo.rating / 100) * 100;
	...
	return (
		<div className='w-full container bg-slate-700'>
			...
			<div className='w-full p-2'>
				...
				<div className='flex mt-4'>
				...
				</div> */}
					{
						userData &&
						<div className="pr-2">
							<img className='w-10 h-10 rounded-full' src={userData.image} alt={userData.handle} />
						</div>
					}
