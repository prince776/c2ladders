  ...
  return (
    <div className="w-full bg-color">
      ...
      <div className="w-full p-3 md:p-10">
        <div className="top-row flex flex-col-reverse justify-between  md:flex-row sticky top-0 z-10 bg-[#2b2c3e] md:m-10">
          ...
          />
          <div className="flex flex-row w-full justify-between py-2 md:px-10">
            <div className="search-bar relative w-auto justify-between">
              <input
            ...
            <div className="">
              ...
              />
              <label
                className="inline pl-[0.15rem] hover:cursor-pointer text-gray-200"
              >Tags
              </label>
            </div>
          </div>
